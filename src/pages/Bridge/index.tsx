...
export default function Bridge({
  ...
  const pendingText =  parsedAmount?.toSignificant(3) + ' ' + currency?.symbol + ' will be bridged and ' +
    tradedTo + ' ' + currency?.symbol + ' from it will be automaticaly swapped to Native tokens on the destination chain.';
  ...
  return (
    <>
      ...
      <AppBody>
      <AddRemoveBridge/>
      {pausedBridge ? (<PausedBridgeContent />) : (
        <>
      <Wrapper>
            ...
            />
              ...
              <AutoColumn gap="20px">
                ...
                <Row style={{ alignItems: 'flex-end' }}>
                  ...
                  <Slider value={innerLiquidityPercentage} onChange={setInnerLiquidityPercentage} max={isExpertMode ? 100 : 10}/>
