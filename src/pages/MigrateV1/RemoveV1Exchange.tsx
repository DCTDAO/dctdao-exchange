...
import { JSBI, Token, TokenAmount, WGLMR, Fraction, Percent, CurrencyAmount } from '@dctdao/sdk'
    ...
    exchangeContract
      ...
      .then((response: TransactionResponse) => {
        ...
        addTransaction(response, {
          summary: `Remove ${chainId && token.equals(WGLMR[chainId]) ? 'WGLMR' : token.symbol}/ETH V1 liquidity`
        })
  ...
  return (
    <AutoColumn gap="20px">
      ...
      <TYPE.darkGray style={{ textAlign: 'center' }}>
        {`Your Uniswap V1 ${
          chainId && token.equals(WGLMR[chainId]) ? 'WGLMR' : token.symbol
